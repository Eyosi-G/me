...
const AboutMe = () => {
  const skill = (name: string) => (
    <div className="px-3 py-1 bg-gray-200 mr-2 mt-2 rounded-lg text-black">
      {name}
    </div>
  );
  return (
    <section className="px-10 md:pl-36 md:pr-20 py-40" id="about_me">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-5 text-gray-700 text-lg">
        <div className="order-2 md:order-1 mt-5 md:mt-0">
          <div>
            Hello! My name is Eyosiyas. I am a Software Engineer with robust
            problem-solving skills and proven experience in creating and
            designing software. I'm very disciplined, diligent, a quick learner,
