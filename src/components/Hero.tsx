    ...
    return (
        <section className='px-20 flex py-20'>
            ...
            <div>
                ...
                <p className='text-xl w-[50%] mt-5 text-gray-800'>I’m a software engineer specializing in building (and occasionally designing) exceptional digital experiences. </p>
